/**
 * @deprecated Legacy error types and Result pattern.
 * These will be removed when CRUD operations are migrated to Effect (tasks 8.x).
 * New code should use Effect TaggedError types from ./crud-errors.ts
 */

// ============================================================================
// Legacy Error Interfaces
// ============================================================================
...
/** @deprecated Use CrudError (Effect TaggedError union) instead */
...
/** @deprecated Use Effect<T, E> instead */
