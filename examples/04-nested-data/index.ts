	...
	books: [
		...
		},
		{
			...
			metadata: {
				...
				description: "The sky above the port",
			},
...
async function main() {
	...
	console.log(
		`Multi-path update — views: ${multiMeta.views}, rating: ${multiMeta.rating}, country: ${multiAuthor.country}`,
	);
