...
This coordinated release promotes the newly bootstrapped `@proseql/engine`, `@proseql/effect`, and `@proseql/browser` packages through the protected OIDC release path, with Rust/WASM as the browser query and mutation authority. Packages that use Effect require exactly `effect@4.0.0-beta.103`. `@proseql/ai` remains independently versioned and is intentionally deferred.

Browser transaction-origin tracking remains unreliable across unrelated asynchronous work yielded inside a transaction; avoid that interleaving when persistence or watch updates may occur.

### Features
- Add approved npm publication workflow (e65bbe1)
- Add resumable package publication (c1e2d2f)
- Verify packed consumer artifacts (de46ad6)
- Rebuild contracts on Effect 4 (1d2710d)
- Add stateful WASM transactions (d018bce)
- Add sparse WASM result projection (43c0260)
- Apply mutation deltas incrementally (6d9d2eb)
- Enforce TypeScript performance parity (1d2cdf3)
- Optimize WASM build and dispatch (58d6ca4)
- Establish paired wasm performance contract (3362526)
- Run Rust engine across browser storage hosts (b90693f)
- Add Rust engine adapter and parity gate (1ada545)
- Add WASM and Promise binding (468d8bf)
- Add transactions, migrations, hooks, and plugins (807bd87)
- Implement reactive subscriptions (8d64b80)
- Implement formats and storage hosts (917ceaf)
- Implement relationships, population, and cascade semantics (2a4fbc4)
- Implement query pipeline (414fffd)
- Implement CRUD semantics (9305e81)
- Scaffold Rust engine contract (405735a)

### Fixes
- Use npm trusted publishing (158603a)
- Reap timed-out tar commands (67070e3)
- Bound Rust test worker concurrency (42ce8cd)
- Bound packed verification commands (ead12f2)
- Preserve per-trial browser limits (b46357c)
- Aggregate independent browser trials (0ba9ba5)
- Harden reviewed publication workflow (fe32330)
- Minimize publisher runtime permissions (4089343)
- Validate publication workflow shell (9c290d4)
- Bound tarball inspection commands (abfabbf)
- Bind publication to reviewed commits (42322b9)
- Keep workspace lock versions coordinated (7023c06)
- Stabilize expanded corpus gate (1e79f32)
- Check Rust formatting non-destructively (83054af)
- Reset tar extraction roots (c163d21)
- Load browser-safe Hjson bundle (55eb44a)
- Disable lifecycle scripts during inspection (5dc9c5d)
- Validate tarballs before extraction (6663fb6)
- Close owned handler databases (b9b0708)
- Export typed result contracts (85699cd)
- Derive entity result contracts (2260b42)
- Encode operation failures (d3936a3)
- Reject malformed filters before execution (daa66d6)
- Expose committed state inside after hooks (a1655b7)
- Reject stale WASM bindings (e7b30c9)
- Isolate full benchmark suites (e0e0865)
- Preserve WASM callback semantics (6fbb969)
- Preserve boundary and indexed query parity (a4071c0)
- Update schemas for Effect 4 (78bc9ba)
- Expand parity coverage (dd83238)

### Other
- Complete package release preparation (b33c654)
- Update Rust package guidance (8172b11)
- Add npm publication runbook (3c8f207)
- Derive package fixture version (0838277)
- Enforce complete browser release budgets (f011bac)
- Preserve reactive timeout contract (bbeb8bc)
- Pin TypeScript compiler (2bd9f25)
- Gate publishable package readiness (f7626eb)
- Format release package sources (aef02f6)
- Enforce browser and peer contracts (f986543)
- Enforce publish manifest contracts (c334f2b)
- Prove serialized stream cancellation (e91fe9b)
- Clarify exported failure schemas (6d3f5c7)
- Verify client and stream boundaries (46eaec0)
- Exercise serialized contracts (64054de)
- Document first-release Effect 4 API (f835aee)
- Upgrade workspace to beta.103 (121e438)
- Add package publication plan (3824bcf)
- Record current optimization status (95b446c)
- Cover benchmark and WASM loaders (1a2a356)
- Mirror validated persistence state (dc28300)
- Accelerate WASM bulk mutations (452bcc0)
- Accelerate WASM relationship population (2b7b341)
- Cache authorized WASM query structure (1d5506e)
- Accelerate canonical WASM queries (1995f31)
- Batch predicate mutations (43daa40)
- Compact WASM read transport (35a8e9c)
- Raise WASM optimization goal to TypeScript parity (39dd652)
- Build and test the Rust crates through the flake (7ba57cf)
- Remove package publishing jobs (dd7e840)
- Disable package publishing by default (fac4183)
- Make parity reports reproducible (45a233f)
- Complete phase two parity gate (7235fb5)
...
### Features
- Auto-detect release bump type from conventional commits (f08a49c)
- Add jsonl codec for newline delimited json (a7a404c)
- Restructure into bun workspace with scoped packages (ef571ed)

### Fixes
- Quote if expression as YAML string (5886b72)
- Quote if expression to fix YAML syntax error (7d2fd08)
- Push commit and tag to origin in release script (b1cce9b)
- Resolve CI failures and add gh to devShell (5a6a181)
...
### Other
- Add workflow_dispatch trigger for manual reruns (4761a9f)
- Automate release and publish on main push (a6db0f7)
- Add numeric prefixes to example directories (311bbb4)
- Use nix develop in publish workflow for environment parity (c6253a5)
- Restructure examples into folders and close feature gaps (b6fe84b)
- Use nix develop for reproducible CI environment (11fbb85)
