...
- [x] 10.3 Test onChange fires on delete with `type: "delete"`
- [x] 10.4 Test onChange fires after specific after-hooks
- [x] 10.5 Test onChange works alongside specific hooks
- [x] 10.6 Test onChange error does not fail the operation

## 11. Tests — Batch and Upsert

- [x] 11.1 Test createMany: hooks run per entity
- [x] 11.2 Test updateMany: hooks run per entity
- [x] 11.3 Test deleteMany: hooks run per entity
- [x] 11.4 Test upsert create path: triggers beforeCreate/afterCreate/onChange("create")
- [x] 11.5 Test upsert update path: triggers beforeUpdate/afterUpdate/onChange("update")

## 12. Cleanup

- [x] 12.1 Run full test suite (`bun test`) to verify no regressions
- [x] 12.2 Run type check (`bunx tsc --noEmit`) to verify no type errors
