...
- [ ] 1.1 Create `core/types/index-types.ts` with `IndexMap` (`Map<unknown, Set<string>>`), `IndexRef` (`Ref<IndexMap>`), `CollectionIndexes` (`Map<string, IndexRef>`), and `NormalizedIndex` (`ReadonlyArray<string>`) types
